...
function operateLineObjectHTML(objSelector, id, isParent, width, color, offset, op) {
    ...
    for (var i = 0; i < objNames.length; i++) {
        ...
        if (op == 'DRAW') {
            var line = new v3d.LineHTML(new v3d.Color(color),
                    width);
            line.offset = offset;
            line.elemHTML = elem;
            obj.add(line);
